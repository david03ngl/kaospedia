...
class ConnectedHeader extends Component {
  ...
  render() {
    ...
    return (
      <AppBar
        position="static"
        style={{ backgroundColor: "#1E90FF", height: 80 }}
      >
        <Toolbar style={{ height: "100%" }}>
          <div className="left-part">
            ...
            <Select
              style={{ maxWidth: 200, marginTop: 1, marginLeft: 20, color: "#ffffff" }}
            ...
            <Button
              style={{ marginLeft: 20, backgroundColor: "#1e90ff", color: "#ffffff", borderColor: "#ffffff" }}
              variant="outlined"
              onClick={() => {
          ...
          <div className="right-part">
            {!this.props.loggedInUser ? (
              <Button
                variant="outlined"
                style={{ marginRight: 20, color: "#ffffff", borderColor: "#ffffff" }}
                onClick={() => {
              ...
              <Avatar
                ...
                style={{ backgroundColor: "#ffffff", marginLeft: 50 }}
              >
                <Person />
              </Avatar>
            )}
